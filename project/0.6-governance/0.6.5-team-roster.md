...
flowchart TB
    ...
    subgraph Tech["Technology SMEs (Phase 1)"]
        TR[Trinity<br/>Next.js, React, Tailwind]
...
**Coordinates With:** Trinity (database connection), Julia (database testing), Alex (data architecture)

---

### Technology SMEs (Phase 1 Active)

#### Trinity - Next.js, React & Tailwind SME (PRIMARY DEVELOPER)
| Attribute | Value |
|-----------|-------|
| **Agent Name** | Trinity |
...
**Coordinates With:** Alex (architecture), Ola (UI components), James (MCP), Julia (testing), William (database)
...
| Deliverable | Agent Zero | Alex | Julia | William | Trinity | Ola | James |
|-------------|:----------:|:----:|:-----:|:-------:|:-------:|:---:|:-----:|
| **Architecture ADR** | A | R | C | C | C | I | C |
| **Next.js Scaffold** | A | C | C | I | R | C | I |
| **Prisma Schema** | A | R | C | C | R | I | I |
| **Database Setup** | A | C | C | R | C | I | I |
| **Redis Setup** | A | C | C | R | C | I | I |
| **UI Components** | A | C | C | I | R | R | I |
| **MCP Client (8 tools)** | A | C | C | I | R | I | R |
| **History View** | A | C | C | I | R | R | I |
| **Test Suite** | A | C | R | C | C | I | C |
| **Quality Gates** | R | C | R | C | C | I | C |
...
|--------|-----|------|---------|-------|
| hx-cc-server | 192.168.10.224 | 3000 | Development server | Trinity |
| hx-docling-mcp-server | 192.168.10.217 | 8000 | MCP document processing | James |
| hx-postgres-server | 192.168.10.208 | 5432 | Job & results persistence | William |
...
|-------|------|--------------|
| Trinity | Lead | Next.js 16 scaffold, Tailwind, shadcn, Prisma setup |
...
| Trinity | Support | Prisma client, Redis client integration |
| Alex | Review | Data architecture validation |

### Sprint 1.3: Upload Component & Persistent Storage
| Agent | Role | Deliverables |
|-------|------|--------------|
| Trinity | Lead | UploadZone.tsx, FilePreview.tsx, /api/upload |
...
| Agent | Role | Deliverables |
|-------|------|--------------|
| Trinity | Lead | UrlInput.tsx, validation |
...
| Trinity | Support | API route integration |
...
| Trinity | Support | Fix integration issues |
| William | Support | Database persistence validation |

### Sprint 1.6: Results Viewer
| Agent | Role | Deliverables |
|-------|------|--------------|
| Trinity | Lead | ResultsViewer.tsx, tabs, renderers |
...
| Agent | Role | Deliverables |
|-------|------|--------------|
| Trinity | Lead | HistoryView.tsx, JobRow.tsx, /api/history |
...
| Trinity | Support | Bug fixes, performance optimization |
...
| Trinity | All components functional | 20 AC criteria |
...
```mermaid
flowchart TB
    Tech[Technology SMEs<br/>Trinity, Ola, James]
    Core[Core Team SMEs<br/>Alex, Julia, William]
...
| William Chen | `@william` | Database, infrastructure | 1 |
| Trinity | `@trinity` | Next.js, React, Tailwind | 1 |
